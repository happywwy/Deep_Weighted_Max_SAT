...
with open(opt['path'] + "data/Aspect_Opinion/uni_token_pos_resall16", "rb") as f:
...
f_aspect_train = open(opt['path'] + "data/Aspect_Opinion/aspectTerm_res16", "r")
f_aspect_test = open(opt['path'] + "data/Aspect_Opinion/aspectTerm_restest16", "r")

f_opinion_train = open(opt['path'] + "data/Aspect_Opinion/sentence_res16_op", "r")
f_opinion_test = open(opt['path'] + "data/Aspect_Opinion/sentence_restest16_op", "r")
...
f_text_train = open(opt['path'] + "data/Aspect_Opinion/sentence_res16", "r")
f_text_test = open(opt['path'] + "data/Aspect_Opinion/sentence_restest16", "r")
sentences_train = f_text_train.read().splitlines()
sentences_test = f_text_test.read().splitlines()
f_text_train.close()
f_text_test.close()

f_raw_parses_res_train = open(opt['path'] + 'data/Aspect_Opinion/raw_parses_res16')
f_raw_parses_res_test = open(opt['path'] + 'data/Aspect_Opinion/raw_parses_restest16')
...
cPickle.dump((pos_train, pos_test), open(opt['path'] + "data/Aspect_Opinion/pos_res16.tag", "wb"))
cPickle.dump(labels_train, open(opt['path'] + "data/Aspect_Opinion/labels_res16.train", "wb"))
cPickle.dump(labels_test, open(opt['path'] + "data/Aspect_Opinion/labels_res16.test", "wb"))
cPickle.dump(words_train, open(opt['path'] + "data/Aspect_Opinion/words_res16.train", "wb"))
cPickle.dump(words_test, open(opt['path'] + "data/Aspect_Opinion/words_res16.test", "wb"))
cPickle.dump(embedding, open(opt['path'] + "data/Aspect_Opinion/embedding300_res16", "wb"))
cPickle.dump(idxs_train, open(opt['path'] + "data/Aspect_Opinion/idx_res16.train", "wb"))
cPickle.dump(idxs_test, open(opt['path'] + "data/Aspect_Opinion/idx_res16.test", "wb"))
cPickle.dump(parse_pos_train, open(opt['path'] + "data/Aspect_Opinion/parse_pos_res16.train", "wb"))
cPickle.dump(parse_pos_test, open(opt['path'] + "data/Aspect_Opinion/parse_pos_res16.test", "wb"))
