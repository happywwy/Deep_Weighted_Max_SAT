...
uni_token_pos_laptop_train = cPickle.load(open(opt['path'] + "data/Aspect_Opinion/uni_token_pos_laptop", "rb"))
uni_token_pos_laptop_test = cPickle.load(open(opt['path'] + "data/Aspect_Opinion/uni_token_pos_laptest", "rb"))

f_aspect_train = open(opt['path'] + "data/Aspect_Opinion/aspectTerm_laptop", "r")
f_aspect_test = open(opt['path'] + "data/Aspect_Opinion/aspectTerm_laptest14", "r")

f_opinion_train = open(opt['path'] + "data/Aspect_Opinion/sentence_laptop_op", "r")
f_opinion_test = open(opt['path'] + "data/Aspect_Opinion/sentence_laptest14_op", "r")

words_train = [[item[0] for item in uni] for uni in uni_token_pos_laptop_train]
words_test = [[item[0] for item in uni] for uni in uni_token_pos_laptop_test]

pos_train = [[item[1] for item in uni] for uni in uni_token_pos_laptop_train]
pos_test = [[item[1] for item in uni] for uni in uni_token_pos_laptop_test]
...
dic_file = open(opt['path'] + "data/Aspect_Opinion/w2v_amazon300_5.txt", "r")
dic = dic_file.readlines()
dic_file.close()

f_text_train = open(opt['path'] + "data/Aspect_Opinion/sentence_laptop", "r")
f_text_test = open(opt['path'] + "data/Aspect_Opinion/sentence_laptest14", "r")
sentences_train = f_text_train.read().splitlines()
sentences_test = f_text_test.read().splitlines()
f_text_train.close()
f_text_test.close()

f_raw_parses_laptop_train = open(opt['path'] + 'data/Aspect_Opinion/raw_parses_laptop')
f_raw_parses_laptop_test = open(opt['path'] + 'data/Aspect_Opinion/raw_parses_laptest')

parse_train = f_raw_parses_laptop_train.read().splitlines()
parse_test = f_raw_parses_laptop_test.read().splitlines()

f_raw_parses_laptop_train.close()
f_raw_parses_laptop_test.close()
...
cPickle.dump((pos_train, pos_test), open(opt['path'] + "data/Aspect_Opinion/pos_laptop.tag", "wb"))
cPickle.dump(labels_train, open(opt['path'] + "data/Aspect_Opinion/labels_laptop.train", "wb"))
cPickle.dump(labels_test, open(opt['path'] + "data/Aspect_Opinion/labels_laptop.test", "wb"))
cPickle.dump(words_train, open(opt['path'] + "data/Aspect_Opinion/words_laptop.train", "wb"))
cPickle.dump(words_test, open(opt['path'] + "data/Aspect_Opinion/words_laptop.test", "wb"))
cPickle.dump(embedding, open(opt['path'] + "data/Aspect_Opinion/embedding300_laptop", "wb"))
cPickle.dump(idxs_train, open(opt['path'] + "data/Aspect_Opinion/idx_laptop.train", "wb"))
cPickle.dump(idxs_test, open(opt['path'] + "data/Aspect_Opinion/idx_laptop.test", "wb"))
cPickle.dump(parse_pos_train, open(opt['path'] + "data/Aspect_Opinion/parse_pos_laptop.train", "wb"))
cPickle.dump(parse_pos_test, open(opt['path'] + "data/Aspect_Opinion/parse_pos_laptop.test", "wb"))
